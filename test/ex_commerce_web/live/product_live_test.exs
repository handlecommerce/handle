defmodule ExCommerceWeb.ProductLiveTest do
  use ExCommerceWeb.ConnCase

  import Phoenix.LiveViewTest
  import ExCommerce.CatalogFixtures

  @create_attrs %{archived_at: "2023-02-15T00:39:00", description: "some description", name: "some name"}
  @update_attrs %{archived_at: "2023-02-16T00:39:00", description: "some updated description", name: "some updated name"}
