defmodule ExCommerceWeb.AssetLiveTest do
  use ExCommerceWeb.ConnCase

  import Phoenix.LiveViewTest
  import ExCommerce.ResourcesFixtures

  @create_attrs %{archived_at: "2023-02-07T00:45:00", content: "some content", file_path: "some file_path", filename: "some filename"}
  @update_attrs %{archived_at: "2023-02-08T00:45:00", content: "some updated content", file_path: "some updated file_path", filename: "some updated filename"}
